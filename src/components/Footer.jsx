      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 border-b border-gray-700 pb-10">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-4 mt-4">
            ...
            <img src="img url" alt="LPI" className="w-20" />
          </div>
        </div>

        {/* Contact Us */}
        <div>
          <h3 className="uppercase font-semibold text-lg mb-4 border-b border-gray-600 inline-block">
            Contact Us
          </h3>
          ...
          <div className="mt-3 space-y-2 text-gray-300">
            ...
            <p className="flex items-center gap-2 hover:text-gray-400 transition">
              <FaEnvelope /> info@indianagency.in
            </p>
            <p className="flex items-center gap-2 hover:text-gray-400 transition">
              <FaRegIdCard /> RERA ID: xyz12345678
            </p>
          </div>
        ...
        <div className="space-y-4 text-gray-300">
          ...
          <img src="img url" alt="CREDAI" className="w-24" />
        </div>
      </div>
